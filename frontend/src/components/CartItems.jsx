...
const CartItems = () => {
  ...
  const totalAmount = couponApplied
  ...
  return (
    <section className="max_padd_container pt-28">
      ...
      <div className="flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[30%]">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10">
              <form onSubmit={handleCouponSubmit}>
                ...
                />
                <button className="btn_dark_rounded" type="submit">
                  Submit
                </button>
              </form>
            </div>
            {couponApplied && (
              <div className="text-green-600">Coupon applied! ₹100 off.</div>
            )}
            {errorMessage && (
